  ...
  return (
    <>
      ...
      <main className="relative z-10 w-full max-w-4xl px-6 flex flex-col items-center">
        ...
        <div className="w-full bg-surface-container-low rounded-[2rem] p-12 md:p-24 flex flex-col items-center text-center shadow-[0_32px_64px_-12px_rgba(6,14,32,0.8)] relative overflow-hidden">
          ...
          <div className="mt-16 flex flex-col sm:flex-row gap-4 w-full justify-center">
            <a className="kinetic-gradient text-on-primary-container px-8 py-4 rounded-xl font-bold tracking-tight flex items-center justify-center gap-3 transition-all hover:scale-105 active:scale-95 shadow-[0_12px_40px_rgba(37,99,235,0.2)]" href="/">
              <span className="material-symbols-outlined">home</span>
              Ana Sayfaya Dön
            </a>
            <button className="bg-surface-container-highest/40 border border-outline-variant/20 text-on-surface px-8 py-4 rounded-xl font-bold tracking-tight flex items-center justify-center gap-3 transition-all hover:bg-surface-container-highest/60 hover:border-outline-variant/40 active:scale-95">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none -z-10 overflow-hidden">
        <div className="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] bg-primary/5 rounded-full blur-[150px]"></div>
        <div className="absolute -bottom-[10%] -right-[10%] w-[30%] h-[30%] bg-secondary-container/5 rounded-full blur-[120px]"></div>
      </div>
    </>
  )
}
