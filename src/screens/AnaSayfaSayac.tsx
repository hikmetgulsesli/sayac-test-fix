...
export function AnaSayfaSayac(props: AnaSayfaSayacProps) {
  const { count, dailyGoal, onIncrease, onDecrease, onReset } = props
  const progress = Math.min(100, Math.round((count / dailyGoal) * 100))
        ...
        <div className="w-full max-w-md">
          <div className="bg-surface-container-low rounded-3xl p-8 pt-12 pb-10 text-center relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <button
                onClick={onIncrease}
                className="flex items-center justify-center gap-2 bg-secondary-container text-on-secondary-container py-5 rounded-xl font-bold active:scale-95 transition-all duration-200"
              >
              ...
              <button
                onClick={onDecrease}
                className="flex items-center justify-center gap-2 bg-tertiary-container text-on-tertiary-container py-5 rounded-xl font-bold active:scale-95 transition-all duration-200"
              >
            ...
            <div className="bg-surface-container-low/50 p-4 rounded-2xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-on-surface">{dailyGoal} / {count}</p>
                </div>
              </div>
